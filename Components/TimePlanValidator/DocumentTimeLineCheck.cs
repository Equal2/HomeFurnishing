...
{
    public class DocumentValidation : IDocumentValidation
    {
        private readonly IRepository<DocumentTypeTimeExtension> _documentTypeTimeExtension;
        private readonly IRepository<DocumentTypeTimePlan> _documentTypeTimePlan;
        private readonly IUnitOfWork _unitOfWork;
        public DocumentValidation(IRepository<DocumentTypeTimeExtension> documentTypeTimeExtension, IRepository<DocumentTypeTimePlan> documentTypeTimePlan, IUnitOfWork unitOfwork)
        {
            _documentTypeTimeExtension = documentTypeTimeExtension;
            _documentTypeTimePlan = documentTypeTimePlan;
        ...
        public bool ValidateDocumentLine(DocumentUniqueId Args, string UserName, out string Msg, out bool Continue)
        {
            List<string> UserRoles = (List<string>)System.Web.HttpContext.Current.Session["Roles"];
            Continue = UserRoles.Contains("Admin");
            Msg = "";
